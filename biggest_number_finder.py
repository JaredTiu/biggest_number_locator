...
# compare the 5 inputs given by the user 
    ...
    #compare number 2 to number 3, 4, and 5 
        ...
        if number_2 > number_4: 
            if number_2 > number_5: 
                print(f"The highest number is:", number_2)
    ...
    #compare number 3 to number 4, and 5
        ...
        if number_3 > number_5:
            print(f"The highest number is:", number_3)
...
number_3 = float(input("input third number: "))
number_4 = float(input("input fourth number: "))
number_5 = float(input("input fifth number: ")) 
